...
//   if (!recipe) {
//     return (
//       <p className="text-center text-orange-700 text-lg mt-10">
//         Loading recipe...
//       </p>
//     );
//   }
...
//       <div className="max-w-3xl mx-auto bg-white p-6 rounded-2xl shadow-lg text-gray-800">
...
//         <h3 className="text-2xl font-semibold mt-8 mb-4 text-orange-600">
//           🧂 Ingredients
//         </h3>
